...
<div class="recordUploadWrap">
				...
				<table id="tbList" class="ecloeScrollTable table dataTable" style="width: 100%;margin-top: 0px !important;">
					<thead>
						<tr>
							...
							<th style="width: 40%" title="파일명"><div>파일명</div></th>
							<th style="width: 40%" title="듣기"><div>듣기</div></th>
							...
							<div class="formWrap">
								...
								<div class="formInput">
									<div class="bxWP100 fileinput fileinput-new" data-provides="fileinput">
										<div class="ecoleFile">
											<button class="btnGray btnBlock" >음원 파일 선택</button>
	...
	<!-- 끝: 음원 등록 -->
		...
		$.getScript(getContextPath() + "/resources/service/js/service/ivrRecordUpload.js").done(function(script, textStatus) {
			if (!!ecoletree.vc && ecoletree.vc.name === "ivrRecordUpload") {
