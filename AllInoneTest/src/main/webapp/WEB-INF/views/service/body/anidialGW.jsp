...
<div class="gateMgtWrap">
	...
	<!-- 타이틀 -->
	<div class="titleWrap">
		<h1>Anidial Gateway</h1>
		<span>AniMamager &gt; Anidial Gateway</span>
	</div>
		...
		<div class="ecloeScrollTableContainer">
			...
			<div class="ecloeScrollTableWrap dataTables_wrapper form-inline">
				<table id="tbList" class="ecloeScrollTable table table-hover dataTable" style="width: 100%;margin-top: 0px !important;">
					<thead>
						<tr>
							<th style="width: 20%" title="그룹"><div>그룹</div></th>
							<th style="width: 20%" title="PREFIX4"><div>PREFIX</div></th>
							<th style="width: 20%" title="GATEWAY ID"><div>GATEWAY ID</div></th>
							<th style="width: 20%" title="GATEWAY"><div>GATEWAY</div></th>
							<th style="width: 20%" title="GATEWAY PREFIX"><div>GATEWAY PREFIX</div></th>
						</tr>
					</thead>
	...
	<div class="footLeftWrap">
		<button id="btnAdd" class="btnMain" style="display:none;">Anidial Gateway 추가</button>
	</div>
	<!-- 좌측 끝: 리스트 -->
				...
				<fieldset>
					<div class="formWrap">
						...
						<div class="formInput">
							...
							<input id="iptUGWGroupId" name="group_gw_id" type=text placeholder="새로운 그룹 ID" disabled="disabled" class="marginB5">
							<input id="iptUGWGroupName" name="group_gw_name" type=text placeholder="새로운 그룹 명" />
						</div>
					</div>
					<div class="formWrap">
					...
					<div class="formWrap">
						...
						<div class="formInput">
							<input name="gw_id" type="text" disabled="disabled" maxlength="3">
						</div>
					</div>
					<div class="formWrap">
	...
	<div class="footRightWrap">
		...
		<button id="btnDelete" type="button" class="btnGray" style="display:none;">Anidial Gateway 삭제</button>
	</div>
	<!-- 우측 끝: 상세 -->
	
	<!-- 우측: 값없음  style="display: block;" -->
	<div class="contRightNoData" style="display: block;">
		<h6>Anidial Gateway가 없습니다.</h6>
		<p>Anidial Gateway를 추가하거나 검색조건을 수정해 주세요.</p>
	</div>
	...
	<script type="text/javascript">
		$.getScript(getContextPath() + "/resources/service/js/service/anidialGW.js").done(function(script, textStatus) {
			if (!!ecoletree.vc && ecoletree.vc.name === "anidialGW") {
