...
<button id="btnSelectGroupSample">select group sample page ></button>
<div>
<h4>조회</h4>
...
<script type="text/javascript">
	$.getScript(getContextPath() + "/resources/service/makeSelect.js").done(function(script, textStatus) {
		if (!!ecoletree.vc && ecoletree.vc.name === "makeSelect") {
